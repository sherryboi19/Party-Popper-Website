...
<head>
    ...
    <title>Party Popper | Search</title>
        ...
        <div class="row">
            ...
            <div class="row">
                ...
                if(isset($_GET['search_pro']))
                {
                    ...
                    $search_query="select * from `products` where Product_KW like '%$search%'";
                    $result=mysqli_query($con,$search_query);
                    $num=mysqli_num_rows($result);
                    if($num==0)
                    {
                        echo"<h4 class='text-center' style='color:#f380bb'>No Item Found!</h4>";
                    }
                    while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        <div class='card'>
                            ...
                            <h4>Rs.$pro_price/-</h4>
                            <a href='search.php?pro_id=$pro_id&add_to_cart=$pro_id' class='btn btn-primary' >Add to Cart</a>
                            </div>
                        </div>
                        </div>";
                    }
