...
<head>
    ...
    <title>Party Popper | Item Category</title>
...
<section>            
        ...
        <div class="options mb-5">
            ...
            <a class="active m-2" href="itemcategory.php">ITEM CATEGORY</a>
    ...
    <section>
        <div class="row">
            <div class="col-md-3">
                <ul class="sidenavbar">
                <li><h6>Home / Item Category</h6></li>
		        <hr>
            ...
            <?php
                ...
                if(!isset($_GET['category'])){            
                    ...
                    while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        <div class='card'>
                            <img src='./admin/category_images/$cat_img' class='card-img-top' alt='$cat_name'>
                            <div class='card-body'>
                            <h6><a class= 'producttitle' href='itemcategory.php?category=$cat_id'>$cat_name</a></h6>
                            </div>
                        </div>
                        </div>";
                    }
                    ...
                    $cat=$_GET['category'];
                    $select_query="select * from `products` where Category_ID=$cat";
                    $result=mysqli_query($con,$select_query);
                    $num=mysqli_num_rows($result);
                    if($num==0)
                    {
                        echo"<h4 class='text-center' style='color:#f380bb'>No Item Found in this Category</h4>";
                    }
                    while($row=mysqli_fetch_assoc($result))
                    {
                        ...
                        <div class='card'>
                            ...
                            <h4>Rs.$pro_price/-</h4>
                            <a href='itemcategory.php?category=$cat_id&add_to_cart=$pro_id' class='btn btn-primary' >Add to Cart</a>
                            </div>
                        </div>
                        </div>";
                    }
