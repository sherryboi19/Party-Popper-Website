...
<head>
    ...
    <title>Party Popper | Themes</title>
...
<section>            
        ...
        <div class="options mb-5">
            ...
            <a class="active m-2" href="themes.php">THEMES</a>
        ...
        <div class="row">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                        <h6><a class= "producttitle" href="#">Girls Themes</a></h6>
                        </div>
                    </div>
                    </div>
                    <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <h6><a class= "producttitle" href="#">Boys Themes</a></h6>
                        </div>
                    </div>
                    </div>
                    <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                        <h6><a class= "producttitle" href="#">Adult Themes</a></h6>
                        </div>
                    </div>
                    </div>
                </div>
